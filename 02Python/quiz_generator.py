...
# ✅ Save PDF in the same folder as your script
...
content.append(Paragraph(
    "This quiz covers **Programming Language basics, JavaScript introduction, variables, and data types**.<br/>"
...
# Add questions with visual styling
...
# Build PDF
doc.build(content)
print(f"✅ PDF generated: {quiz_pdf_enhanced}")
